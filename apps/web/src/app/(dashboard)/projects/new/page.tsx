...
export default function NewProjectPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-slate-800 rounded-xl border border-slate-700 p-6 space-y-5">
        ...
        <div className="flex flex-wrap justify-end gap-3 pt-2">
          <Link href="/projects" className="px-4 py-2 border border-slate-600 text-slate-400 rounded-lg text-sm hover:bg-slate-700 hover:text-white transition-colors">Cancelar</Link>
...
const inputCls = 'w-full px-3 py-2 border border-slate-600 bg-slate-900 text-white rounded-lg text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500';
